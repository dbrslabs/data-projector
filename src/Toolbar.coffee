   ...
   createDispatcher : =>
      ...
      @dispatcher = [ { id : "#menuButton", key : 0, modifier : Utility.NO_KEY, type : Toolbar.EVENT_MENU },
                    ...
                    # { id : "#animateButton", key : 0, modifier : Utility.NO_KEY, type : Toolbar.EVENT_ANIMATE },
                      ...
                      { id : "#section-selector-toolbar", key : 0, modifier : Utility.NO_KEY, type : Toolbar.EVENT_SECTION_SELECTION },
                      { id : "#section-selector-in-viz", key : 0, modifier : Utility.NO_KEY, type : Toolbar.EVENT_SECTION_SELECTION },
